...
```bash
git clone https://github.com/Tej36asvi/MD-Simulation-of-radiation-hardness-and-self-healing-of-GaN.git
```
...
1. Open OVITO and load `dump/dump.cascade.lammpstrj`
2. Add modifier: **Wigner-Seitz Defect Analysis**
3. Set reference to **External File** and load `data/GaN_0K_reference.data`
4. Enable **Distinguish atom types**
5. Export the per-frame defect counts to a text file and save as `results/defect_counts`
...
| Quantity | Value |
|---|---|
| Peak Frenkel pairs | 494 (frame 24) |
| Surviving Frenkel pairs | ~113 (frame 140) |
| Defect recovery fraction | ~77 % |
| Peak cascade pressure | ~26,800 bar |
| Peak effective temperature | ~1000 K |
